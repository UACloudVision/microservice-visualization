import type { IRData, Microservice, Controller, Service, Method } from '../parsers/getData';
...
export default function filterNodes(
    myData: IRData,
    arrayOfNodes: string[]
): [FilteredGraphData, MicroserviceColors, EndpointCalls] {

    const finalNodes: FilteredNode[] = [];
    const finalLinks: FilteredLink[] = [];
    const componentMethods = new Map<string, any>(); // Maps component name to its methods
